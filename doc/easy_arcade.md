...
USB-PD電源とUSBコントローラーを使用することで、比較的簡単に遊べることを目指しています。
...
- 初期設定ではUSB-CポートにUSB-PD電源からのケーブルを接続すると待機状態に移行します
- USB-Micro端子はファームウェアアップデート用です
- 絶対にUSB-CとUSB-Microの端子両方から電源を供給しないようにしてください
